...
INSERT INTO USERS(USERID, USERNAME, PRIMARYEMAIL, PASSWORD, COMMENTS, CREATEDBY, CREATEDDATE, LASTMODIFIEDBY, LASTMODIFIEDDATE)
     VALUES (1, 'barnbarn', 'barnbarn@host.local', '$2y$07$iAIQSfGBTEs9DeFHZmJKbu11Cka1S0hR3dLn0ZH9GKObPQpO7qCa', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (2, 'cinnamon', 'cinnamon@host.local', '$2y$07$iAIQSfGBTEs9DeFHZmJKbu11Cka1S0hR3dLn0ZH9GKObPQpO7qCa', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (3, 'stumps', 'stumps@host.local', '$2y$07$iAIQSfGBTEs9DeFHZmJKbu11Cka1S0hR3dLn0ZH9GKObPQpO7qCa', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
